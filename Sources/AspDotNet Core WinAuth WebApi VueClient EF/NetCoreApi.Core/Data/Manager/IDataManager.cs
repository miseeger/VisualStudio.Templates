...
namespace $safeprojectname$.Data.Manager
{
    public interface IDataManager
    {
        ...
        Task<AlbumViewModel> AddAlbumAsync(AlbumViewModel newAlbumViewModel,
        ...
        Task<ArtistViewModel> AddArtistAsync(ArtistViewModel newArtistViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdateArtistAsync(ArtistViewModel artistViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<List<CustomerViewModel>> GetCustomerBySupportRepIdAsync(int id,
            CancellationToken ct = default(CancellationToken));

        Task<CustomerViewModel> AddCustomerAsync(CustomerViewModel newCustomerViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdateCustomerAsync(CustomerViewModel customerViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<EmployeeViewModel> AddEmployeeAsync(EmployeeViewModel newEmployeeViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdateEmployeeAsync(EmployeeViewModel employeeViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> DeleteEmployeeAsync(int id, CancellationToken ct = default(CancellationToken));

        Task<List<EmployeeViewModel>> GetEmployeeDirectReportsAsync(int id,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<GenreViewModel> AddGenreAsync(GenreViewModel newGenreViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<List<InvoiceLineViewModel>> GetInvoiceLineByTrackIdAsync(int id,
            CancellationToken ct = default(CancellationToken));

        Task<InvoiceLineViewModel> AddInvoiceLineAsync(InvoiceLineViewModel newInvoiceLineViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdateInvoiceLineAsync(InvoiceLineViewModel invoiceLineViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<List<InvoiceViewModel>> GetInvoiceByCustomerIdAsync(int id,
            CancellationToken ct = default(CancellationToken));

        Task<InvoiceViewModel> AddInvoiceAsync(InvoiceViewModel newInvoiceViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdateInvoiceAsync(InvoiceViewModel invoiceViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<MediaTypeViewModel> AddMediaTypeAsync(MediaTypeViewModel newMediaTypeViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdateMediaTypeAsync(MediaTypeViewModel mediaTypeViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<PlaylistViewModel> AddPlaylistAsync(PlaylistViewModel newPlaylistViewModel,
            CancellationToken ct = default(CancellationToken));

        Task<bool> UpdatePlaylistAsync(PlaylistViewModel playlistViewModel,
            CancellationToken ct = default(CancellationToken));
        ...
        Task<List<TrackViewModel>>
            GetTrackByMediaTypeIdAsync(int id, CancellationToken ct = default(CancellationToken));

        Task<List<TrackViewModel>> GetTrackByPlaylistIdIdAsync(int id,
            CancellationToken ct = default(CancellationToken));

        Task<TrackViewModel> AddTrackAsync(TrackViewModel newTrackViewModel,
            CancellationToken ct = default(CancellationToken));
